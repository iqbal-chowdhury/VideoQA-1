...
if __name__ == '__main__':
	...
	# f_type = '224x224_VGG_all_clips'
	# feature_path = '/home/xyj/usr/local/data/movieqa/224x224_movie_all_clips_vgg_'+str(timesteps_v)+'f.h5'
	# pca_mat_init_file = '/home/xyj/usr/local/code/VideoQA/model/224x224_vgg_all_clip_pca_mat.pkl'
