...
def build_model(input_video, input_stories, input_question, input_answer, 
	...
	with tf.variable_scope('video_subtitle_hierarchical_frame_clip_question') as scope:
		...
		embedded_video = HSEModelUtil.getVideoDualSemanticEmbeddingWithQuestionAttention(input_video, T_w2v, embedded_stories, embedded_question, T_B, pca_mat=pca_mat) # batch x timesteps x d_w2v
...
def train_model(train_stories,val_stories,v2i,trained_video_QAs,val_video_QAs,hf,f_type,nql=25,nqa=32,numberOfChoices=5,
	...
	with sess.as_default():
		...
		for epoch in xrange(total_epoch):
			...
			#save model
			export_path = '/home/xyj/usr/local/saved_model/vqa_baseline/video+subtitle_classifier_hierarchical_frame+clip+question'+'/'+f_type+'_b'+str(batch_size)+'/'+'lr'+str(lr)+'_f'+str(feature_shape[0])
...
if __name__ == '__main__':
	...
	# pretrained_model = '/home/xyj/usr/local/saved_model/vqa_baseline/video+subtitle_classifier_hierarchical_frame+clip+question/224x224_GoogLeNet_b8/lr0.01_f16/E4_A0.379232505643.ckpt'
